...
def fetch_content(url):
	...
	league_table = soup.find('div', class_ = 'sp-cn ins_storybody')
	
	
	# print(type(league_table))	
...
session = HTMLSession()
url = "https://news.google.com/search?for=ndtv+political+news+india&hl=en-IN&gl=IN&ceid=IN%3Aen"
r = session.get(url)
